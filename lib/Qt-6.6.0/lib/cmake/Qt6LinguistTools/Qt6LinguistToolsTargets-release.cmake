...
set_target_properties(Qt6::lconvert PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/lconvert"
  )

list(APPEND _cmake_import_check_targets Qt6::lconvert )
list(APPEND _cmake_import_check_files_for_Qt6::lconvert "${_IMPORT_PREFIX}/bin/lconvert" )
...
set_target_properties(Qt6::lprodump PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libexec/lprodump"
  )

list(APPEND _cmake_import_check_targets Qt6::lprodump )
list(APPEND _cmake_import_check_files_for_Qt6::lprodump "${_IMPORT_PREFIX}/./libexec/lprodump" )
...
set_target_properties(Qt6::lrelease PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/lrelease"
  )

list(APPEND _cmake_import_check_targets Qt6::lrelease )
list(APPEND _cmake_import_check_files_for_Qt6::lrelease "${_IMPORT_PREFIX}/bin/lrelease" )
...
set_target_properties(Qt6::lrelease-pro PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libexec/lrelease-pro"
  )

list(APPEND _cmake_import_check_targets Qt6::lrelease-pro )
list(APPEND _cmake_import_check_files_for_Qt6::lrelease-pro "${_IMPORT_PREFIX}/./libexec/lrelease-pro" )
...
set_target_properties(Qt6::lupdate PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/lupdate"
  )

list(APPEND _cmake_import_check_targets Qt6::lupdate )
list(APPEND _cmake_import_check_files_for_Qt6::lupdate "${_IMPORT_PREFIX}/bin/lupdate" )
...
set_target_properties(Qt6::lupdate-pro PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libexec/lupdate-pro"
  )

list(APPEND _cmake_import_check_targets Qt6::lupdate-pro )
list(APPEND _cmake_import_check_files_for_Qt6::lupdate-pro "${_IMPORT_PREFIX}/./libexec/lupdate-pro" )
